...
public class ChromaIntermediaire 
{
	...
	int depart=0;// Au cas où la musique ne commence pas dès le début du fichier son
	...
	Note note= new Note(chromaTheoMorceau.get(0));//juste pour récupérer la tonalité
	...
	int duree=500;// durée minimale d'un accord, selon la période de calcul des transformée de Fourier
